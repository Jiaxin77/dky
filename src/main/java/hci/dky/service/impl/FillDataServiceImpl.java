...
public class FillDataServiceImpl implements FillDataService {
    ...
    public ServerResponse<List> postSusAnswer(int planId,List<Object> answer)
    {
        ...
        criteria3.andPlanIdEqualTo(assessAndPlan.getId());List<SusScaleAnswerPaper> susScaleAnswerPaperList = susScaleAnswerPaperMapper.selectByExample(susScaleAnswerPaperExample1);
